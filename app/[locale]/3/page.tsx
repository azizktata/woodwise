// Version 3 — Warm Nature / Organic Story
...
export default async function Home3({
  ...
  return (
    <div className={cn("font-sans", font.variable)} style={{ background: C.cream }}>
      <HeroV3 data={heroData} locale={locale} />
      <NatureStrip />
      <AboutV3 data={aboutData} />
      <ImpactV3 data={impactData} />
      <ProductV3 data={mbio7Data} locale={locale} />
      <PressV3 data={blogsData} locale={locale} />
      <ReviewsV3 data={reviewsData} />
      <FAQV3 data={faqData} />
      <ContactV3 data={contactData} />
    </div>
  );
}
...
const HeroV3 = ({ data, locale }: { data: HeroSection; locale: string }) => (
  <section
    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-8 py-24 w-full">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a
              ...
              style={{
                ...
                border: `2px solid ${C.leafGreen}60`,
                color: C.forest,
              }}
            >
              Nous contacter
        ...
        <div className="relative">
          {/* Main image with organic border */}
          <div
          ...
          >
            ...
            <div
              ...
              style={{ background: `linear-gradient(135deg, ${C.leafGreen}20, transparent)` }}
            />
          </div>

          {/* Floating cards */}
          <div
            className="absolute -bottom-4 -left-4 rounded-2xl px-5 py-4 shadow-lg"
          ...
          <div
            className="absolute top-8 -right-4 rounded-2xl px-5 py-4 shadow-lg"
            style={{ background: C.warmWhite, border: `1px solid ${C.sand}` }}
          >
...
const AboutV3 = ({ data }: { data: AboutSection }) => {
  const services = [
    ...
    <section className="py-20 sm:py-28" style={{ background: C.warmWhite }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <div className="flex items-center gap-3 mb-12">
          ...
          <span className="text-sm font-semibold uppercase tracking-widest" style={{ color: C.leafGreen }}>
            Notre Histoire
          </span>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-16">
          <div>
            ...
            <div className="space-y-8">
              ...
              <div
                ...
                style={{ background: `${C.leafGreen}08`, borderColor: `${C.leafGreen}20` }}
              >
              ...
              <div
                className="rounded-2xl p-6 border"
                style={{ background: `${C.brightGreen}08`, borderColor: `${C.brightGreen}20` }}
              >
                <div className="flex items-center gap-2 mb-3">
          ...
          <div className="relative flex items-center justify-center">
            <div
              ...
              style={{ borderRadius: "60% 40% 30% 70% / 60% 30% 70% 40%", border: `3px solid ${C.sand}` }}
            >
              <Image
                src={AproposImg}
                alt="À propos"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {services.map((s, i) => (
            ...
            >
              ...
              <h4 className="font-semibold text-sm leading-snug mb-2" style={{ color: C.forest }}>
                {s.title}
              </h4>
              <p className="text-xs leading-relaxed" style={{ color: `${C.darkBrown}99` }}>
                {s.desc}
              </p>
            </div>
          ))}
...
const ImpactV3 = ({ data }: { data: ImpactSection }) => (
  <section
    className="py-20 sm:py-28 relative overflow-hidden"
    style={{ background: `linear-gradient(135deg, ${C.forest}, #0d7f40)` }}
  >
    {/* Decorative */}
    <div
      className="absolute right-0 top-0 w-96 h-96 rounded-full opacity-10"
      style={{ background: `radial-gradient(circle, ${C.brightGreen}, transparent)` }}
    />
    <div
    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
      <div className="text-center mb-16">
        ...
        <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
          {data.title_part1}{" "}
          <span style={{ color: C.brightGreen }}>{data.title_part2}</span>
        </h2>
      ...
      <div className="grid sm:grid-cols-3 gap-6">
        {[
          ...
          <div
            key={i}
            className="text-center rounded-3xl p-10 transition-transform hover:-translate-y-1"
            style={{
          ...
          >
            <p className="text-7xl font-bold mb-4" style={{ color: stat.accent }}>
              {stat.value}
            </p>
...
const ProductV3 = ({ data, locale }: { data: Mbio7Section; locale: string }) => (
    ...
    <div className="max-w-7xl mx-auto px-6 sm:px-8">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="leading-relaxed mb-8 text-sm" style={{ color: `${C.darkBrown}cc` }}>
            {data.description}
          </p>

          {/* Feature tags — leaf-style */}
          <div className="flex flex-col gap-3 mb-8">
            {Object.values(data.tags).map((tag, i) => (
              <div key={i} className="flex items-center gap-3">
                <div
                  className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0"
                  style={{ background: `${C.brightGreen}20` }}
                >
        ...
        <div className="relative">
          ...
          >
            ...
            <div
              className="absolute inset-0"
              style={{ background: `linear-gradient(to top, ${C.forest}60, transparent)` }}
            />
            <div className="absolute inset-0 flex items-center justify-center">
              <Link href="https://www.youtube.com/watch?v=jUQu9_26Gdg" target="_blank" rel="noopener noreferrer">
                <div
                  className="w-16 h-16 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-xl"
...
const PressV3 = ({ data, locale }: { data: BlogsSection; locale: string }) => (
  <section className="py-20 sm:py-28" style={{ background: C.warmWhite }}>
    <div className="max-w-7xl mx-auto px-6 sm:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {pressBlogs.map((blog, i) => (
          <Link key={i} href={blog.link as any} target="_blank" rel="noopener noreferrer" className="group">
            <div
              className="rounded-3xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl h-full flex flex-col"
              style={{
                background: "white",
                border: `1px solid ${C.sand}`,
              }}
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <h4 className="font-bold text-base leading-snug mb-3 flex-1" style={{ color: C.forest }}>
                  {blog.title}
                </h4>
                <p className="text-xs leading-relaxed" style={{ color: `${C.darkBrown}99` }}>
                  {blog.description}
...
const ReviewsV3 = ({ data }: { data: ReviewsSection }) => {
    ...
    <section className="py-20 sm:py-28" style={{ background: C.cream }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-sm max-w-[50ch] mx-auto" style={{ color: `${C.darkBrown}99` }}>
            {data.description}
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {reviews.map((r, i) => (
            ...
            >
              ...
              <p className="text-sm leading-relaxed mb-6 italic" style={{ color: C.darkBrown }}>
...
const FAQV3 = ({ data }: { data: FAQSection }) => {
        ...
        <div className="flex flex-col gap-3">
          {items.map((item, i) => (
            <Accordion key={i} type="single" collapsible>
              <AccordionItem
                value={item.question}
                className="rounded-2xl px-6 overflow-hidden border-0"
                style={{ background: "white", border: `1px solid ${C.sand}` }}
              >
                <AccordionTrigger
                  className="text-left font-semibold py-5 hover:no-underline text-sm"
                  style={{ color: C.forest }}
                >
                  {item.question}
                </AccordionTrigger>
...
const ContactV3 = ({ data }: { data: ContactSectionContent }) => (
  <section id="contact" className="py-20 sm:py-28" style={{ background: C.cream }}>
    <div className="max-w-7xl mx-auto px-6 sm:px-8">
      <div className="text-center mb-16">
      ...
      <div className="grid lg:grid-cols-[3fr_2fr] gap-8 max-w-5xl mx-auto">
        {/* Form */}
        <div
          className="rounded-3xl p-8"
          style={{ background: "white", border: `1px solid ${C.sand}`, boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}
        >
          <div id="contact-form">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <div
              className="absolute inset-0"
              style={{ background: `linear-gradient(135deg, ${C.forest}cc, ${C.leafGreen}80)` }}
            />
            <div className="relative z-10 p-6">
              <h3 className="text-white font-bold text-xl mb-1">{data.contactInfo.title}</h3>
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-3 text-sm" style={{ color: C.darkBrown }}>
                <div
                  ...
                  style={{ background: `${C.leafGreen}15`, color: C.leafGreen }}
                >
                  {item.icon}
                </div>
                {item.val}
